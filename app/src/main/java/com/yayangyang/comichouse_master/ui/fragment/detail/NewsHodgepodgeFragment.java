...
public class NewsHodgepodgeFragment extends BaseRVFragment<NewsCommonPresenter<NewsCommonContract.View>,NewsCommonBody,BaseViewHolder>
        implements NewsCommonContract.View,BaseQuickAdapter.OnItemChildClickListener{

    private int newsType=Constant.NewsType.HODGEPODGE;
