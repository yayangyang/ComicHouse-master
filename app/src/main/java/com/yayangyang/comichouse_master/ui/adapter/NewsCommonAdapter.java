...
public class NewsCommonAdapter extends BaseQuickAdapter<NewsCommonBody,BaseViewHolder> {

    public NewsCommonAdapter(int layoutResId, @Nullable List<NewsCommonBody> data) {
