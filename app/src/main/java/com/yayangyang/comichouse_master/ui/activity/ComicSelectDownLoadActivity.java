...
public class ComicSelectDownLoadActivity extends BaseActivity
    ...
    public static void startActivity(Context context, String comicId,List<ComicDetailHeader.ChaptersBean.DataBean> list) {
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.tv_all){
            ...
            for(int i=0;i<dataList.size();i++){
                ...
                if(comicChapterDownLoadInfo!=null){
                    for(int j=0;j<comicChapterDownLoadInfo.size();j++){
                        if(dataList.get(i).chapter_id.equals(comicChapterDownLoadInfo.get(j))){
                            isClickAble=false;
                            break;
                        }
                    }
            ...
            if(!downLoadList.isEmpty()){
                ...
                ComicDownLoadActivity.startActivity(this);
            }else{
