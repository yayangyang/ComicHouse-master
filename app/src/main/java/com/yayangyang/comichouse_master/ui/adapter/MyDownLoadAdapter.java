...
public class MyDownLoadAdapter extends BaseQuickAdapter<ComicDownLoadInfo,BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ComicDownLoadInfo item) {
        ...
        if(item.getDownLoadSize().equals(item.getTotalSize())){
