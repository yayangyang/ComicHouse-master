...
public class NewsLightNovelInformationFragment extends BaseRVFragment<NewsCommonPresenter<NewsCommonContract.View>,NewsCommonBody,BaseViewHolder>
        implements NewsCommonContract.View,BaseQuickAdapter.OnItemChildClickListener{

    private int newsType=Constant.NewsType.LIGHT_NOVEL_INFORMATION;
    ...
    public void onDestroyView() {
        LogUtils.e("NewsLightNovelInformationFragment-onDestroyView");
        super.onDestroyView();
    }
