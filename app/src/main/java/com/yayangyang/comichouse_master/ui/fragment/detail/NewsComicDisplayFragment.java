...
public class NewsComicDisplayFragment extends BaseRVFragment<NewsCommonPresenter<NewsCommonContract.View>,NewsCommonBody,BaseViewHolder>
        implements NewsCommonContract.View,BaseQuickAdapter.OnItemChildClickListener{

    private int newsType=Constant.NewsType.COMIC_DISPLAY;
    ...
    public void onDestroyView() {
        LogUtils.e("NewsComicDisplayFragment-onDestroyView");
        super.onDestroyView();
    }
